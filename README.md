...
**Hollywoo** is a movies app displaying box office and top rental DVDs using [The Movie Database API](http://docs.themoviedb.apiary.io/#).
...
1. How to clear selection highlighting after clicking on movie cell (and if this is necessary?)
2. How to add interactivity? (Can users save a movie? Rate it?) 

## Video Walkthrough 

Here's a walkthrough of implemented user stories:

<img src='http://i.imgur.com/UfFSLJ0.gif' title='Video Walkthrough 2' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

It was particularly difficult to implement the icons because of resizing issues. 
